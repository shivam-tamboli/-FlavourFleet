...
import com.flavorfleet.backend.service.UserService;
import com.flavorfleet.backend.service.ValidUser;
...
@RequestMapping(value = "/flavorfleet/user")// Base URL for all user-related endpoints
